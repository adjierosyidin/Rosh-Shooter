...
public class GameView extends SurfaceView implements Runnable {
    ...
    private Meteor mlove, mlove1, mlove2;
    ...
    void reset() {
        ...
        mlove = new Meteor(getContext(), mScreenSizeX, mScreenSizeY, mSoundPlayer);
        mlove1 = new Meteor(getContext(), mScreenSizeX, mScreenSizeY, mSoundPlayer);
        mlove2 = new Meteor(getContext(), mScreenSizeX, mScreenSizeY, mSoundPlayer);
    ...
    public void draw() {
        if (mSurfaceHolder.getSurface().isValid()) {
            ...
            mCanvas.drawBitmap(mlove.getMlives(), 450, mlove.getYl(), mPaint);
            mCanvas.drawBitmap(mlove1.getMlives(), 520, mlove.getY2(), mPaint);
            mCanvas.drawBitmap(mlove2.getMlives(), 590, mlove.getY3(), mPaint);
            for (Star s : mStars) {
    ...
    void drawScore() {
        ...
        //mCanvas.drawText("Lives : " + lives, 100, 90, score);
    }
